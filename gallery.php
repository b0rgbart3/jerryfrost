...
<div id='largeDSWrapper' class='largeDSWrapper hidden'>
    ...
    <div class='logoWrapper' id='logoWrapper'>
        <div class='logo' id='logo'>
            ...
            <div class='filtersIcon hidden' onClick=expandFilterBox(event) id='filterIcon'><img src='interface/search.svg'/></div>
        </div>
    ...
    <div class='extras' id='extras'>
        <div class='filters' id='queryWrapper'>
            <div class='queryWrapper' id='queryInput'>
            <div class='queryForm' id='queryForm'>
                <label name='queryTitle'>Search:</label>
                <input type='text' size='40' id='query' name='query' class='queryInput' autocomplete="off"/>
                <div class='clearQuery' onclick='clearQuery()'></div>
            </div>
</div>
            <br clear='all'/>
